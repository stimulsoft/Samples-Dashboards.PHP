...
$handler->onEndExportReport = function ($args) {
	...
	// File extension of the exported dashboard
	...
	return StiResult::success('The exported dashboard was saved successfully: '.$args->fileName.'.'.$fileExtension);
	//return StiResult::error('An error occurred while saving the exported dashboard: '.$fileName);
};
